...
class FileSystem {
  public:
    ...
    bool Create(char *name,int initialSize,int fileType);  	
					// Create a file (UNIX creat)
//	bool createDir(char *absPath,char *dirPath);
	OpenFile* Open(char *name); 	// Open a file (UNIX open)
//	OpenFile* Open(char *absPath);
	...
	void changePWD(char *name);

	void listOne(char *filename);
	bool extendFile(char *name,int extrasize);
